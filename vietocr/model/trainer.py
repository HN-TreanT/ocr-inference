...
class Trainer():
    mlflow.set_tracking_uri('http://172.0.0.1:5000')
    try:
    # Set the experiment
      mlflow.set_experiment("cs1")
    except mlflow.exceptions.MlflowException as e:
       print("Failed to set experiment:", e)
    mlflow.set_experiment('cs1')
...
#            **config['optimizer'])
    ...
    def train(self):
        with mlflow.start_run():
            ...
            mlflow.set_tag('model name', 'vietocr handwriting')
            ...
            for i in range(self.num_iters):
                ...
                if self.iter % self.print_every == 0:
                    ...
                    # mlflow.log_params(self.optimizer.param_groups[0]['lr'])
                    mlflow.log_metric('average train_loss', total_loss/self.print_every)
                    total_loss = 0
                    total_loader_time = 0
                    total_gpu_time = 0
                    print(info)
                ...
                if self.valid_annotation and self.iter % self.valid_every == 0:
                    ...
                    mlflow.log_metric('acc_full_seq', acc_full_seq)
                    mlflow.log_metric('acc_per_char', acc_per_char)
            ...
            mlflow.sklearn.log_model('vietocr handwriting', self.model)
